import svgPaths from "./svg-avz2s0nprz";
...
function Header() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[20px] items-start relative shrink-0 w-full" data-name="Header">
  ...
  return (
    <div className="absolute inset-[0_19.33%_2.67%_16.67%]" data-name="Layer_1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.2 29.2">
        <g clipPath="url(#clip0_5_1429)" id="Layer_1">
  ...
  return (
    <div className="absolute left-[-0.4px] size-[30px] top-[-0.47px]" data-name="Layer_1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g clipPath="url(#clip0_5_1388)" id="Layer_1">
  ...
  return (
    <div className="absolute h-[28.81px] left-[2px] top-px w-[23.93px]" data-name="Layer_1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23.93 28.81">
        <g clipPath="url(#clip0_5_1432)" id="Layer_1">
...
function SidebarContainer() {
  return (
    <header className="bg-[#394508] shrink-0 sticky top-0 w-full" data-name="Sidebar container">
      <div className="content-stretch flex flex-col gap-[50px] items-start px-[40px] py-[20px] relative w-full">
        <Nav />
        <Header />
        <OurOfferings />
        <ContactLinks />
...
function HeaderImage() {
  return (
    <div className="aspect-[720/381] relative rounded-[20px] shrink-0 w-full" data-name="Header image">
  ...
  return (
    <div className="relative size-[20.967px]" data-name="Layer_1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.9675 20.9675">
        <g clipPath="url(#clip0_5_1426)" id="Layer_1">
...
function HeaderContainer() {
  return (
    <div className="bg-white h-[664.643px] relative shrink-0 w-full" data-name="Header container">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[50px] items-center pt-[50px] px-[40px] relative size-full">
          <HeaderImage />
...
function GetMoreDoneSection() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Get more done section">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-center justify-center pt-[80px] px-[40px] relative w-full">
          <Header1 />
          <BentoContainer />
        </div>
      </div>
...
function ReliableAppSection() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Reliable app section">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-center pt-[80px] px-[40px] relative w-full">
          <TheMostReliableApp />
          <SectionContent />
        </div>
      </div>
...
function IconContainer() {
  return (
    <div className="aspect-[150/115.75] relative rounded-[10px] shrink-0 w-full" data-name="Icon container">
...
function FirstClassSoftwareSection() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="First class software section">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-center pt-[48px] px-[40px] relative w-full">
          <SectionHeader />
...
function RightSideFooterContainer() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Medium',sans-serif] font-medium h-[238px] items-start justify-between leading-[1.15] relative shrink-0 text-[12px]" data-name="Right side footer container">
      <ContactDetails />
      <TermsAndConditions />
    </div>
  );
...
function Footer() {
  return (
    <footer className="bg-[#ededed] relative shrink-0 w-full" data-name="Footer">
      <div className="content-stretch flex gap-[10px] items-start px-[40px] py-[31px] relative w-full">
