import svgPaths from "./svg-ebhkiaa9on";
...
import imgImage from "figma:asset/8d837b963fff72eb5b748baf388a129932d42ca7.png";
...
function Nav() {
  return (
    <nav className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="nav">
      <Logo />
...
function Header() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Regular',sans-serif] font-normal gap-[20px] items-start relative shrink-0" data-name="Header">
      <h1 className="block capitalize leading-[0] relative shrink-0 text-[0px] text-[42px] text-white tracking-[-0.84px] w-[339.139px]">
        <span className="leading-[1.058]">{`Money transfers made `}</span>
        <span className="leading-[1.058] text-[#d2fd9c]">simple</span>
      </h1>
      <h2 className="block leading-[1.09] relative shrink-0 text-[#cbcbcb] text-[16px] whitespace-nowrap">No personal credit checks or founder guarantee.</h2>
    </div>
  );
}
  ...
  return (
    <div className="absolute inset-[0_19.33%_2.67%_16.67%]" data-name="Layer_1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.2 29.2">
        <g clipPath="url(#clip0_5_1321)" id="Layer_1">
  ...
  return (
    <div className="absolute left-[-0.4px] size-[30px] top-[-0.47px]" data-name="Layer_1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g clipPath="url(#clip0_5_1353)" id="Layer_1">
  ...
  return (
    <div className="absolute h-[28.81px] left-[2px] top-px w-[23.93px]" data-name="Layer_1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23.93 28.81">
        <g clipPath="url(#clip0_5_1331)" id="Layer_1">
...
function Modules() {
  return (
    <div className="content-stretch cursor-pointer flex gap-[10px] items-start relative shrink-0 w-full" data-name="Modules">
...
function OurOfferings() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Our offerings">
...
function ContactLinks() {
  return (
    <div className="content-stretch cursor-pointer flex gap-[12.8px] items-start relative shrink-0 w-full" data-name="Contact links">
      <a className="content-stretch flex items-center justify-center relative shrink-0" data-name="Link" href="https://figma.com/sites">
      ...
      <a className="content-stretch flex items-center justify-center relative shrink-0" data-name="Link" href="https://figma.com/sites">
        <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.15] relative shrink-0 text-[#d2fd9c] text-[12px] text-left whitespace-nowrap">Legal Terms</p>
      </a>
    </div>
  );
}
...
function SidebarContainer() {
  return (
    <header className="absolute content-stretch flex flex-col gap-[49px] items-start left-[40px] py-[30px] top-0" data-name="Sidebar container">
      <Nav />
      <Header />
      <OurOfferings />
      <ContactLinks />
...
function HeaderImage() {
  return (
    <div className="aspect-[680/379.3265075683594] relative rounded-[20px] shrink-0 w-full" data-name="Header image">
  ...
  return (
    <div className="relative size-[20.967px]" data-name="Layer_1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.9675 20.9675">
        <g clipPath="url(#clip0_5_1373)" id="Layer_1">
...
function HeaderContainer() {
  return (
    <div className="bg-white h-[712.969px] relative shrink-0 w-full" data-name="Header container">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[50px] items-center px-[40px] py-[50px] relative size-full">
          <HeaderImage />
...
function Header1() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 text-center" data-name="Header">
      <h2 className="block capitalize font-['Manrope:Regular',sans-serif] font-normal leading-[1.058] relative shrink-0 text-[#394508] text-[42px] tracking-[-0.84px] whitespace-nowrap">Get more done in a week</h2>
      <h2 className="block font-['Manrope:Medium',sans-serif] font-medium leading-[1.15] relative shrink-0 text-[#5d5d5d] text-[12px] w-[395px]">Maximize your productivity with smarter tools designed to streamline your workflow to automate tasks, stay organized</h2>
    </div>
  );
}
...
function Bento() {
  return (
    <div className="bg-[#d2fd9c] flex-[1_0_0] h-[221.867px] max-w-[500px] min-h-px min-w-[275px] relative rounded-[10.667px]" data-name="Bento 01">
      <div className="flex flex-col items-center justify-end max-w-[inherit] min-w-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-end max-w-[inherit] min-w-[inherit] px-[20.267px] py-[30px] relative size-full">
          <BentoContent />
        </div>
      </div>
    </div>
...
function Bento1() {
  return (
    <div className="bg-[#d2fd9c] flex-[1_0_0] h-[221.867px] max-w-[500px] min-h-px min-w-[275px] relative rounded-[10.667px]" data-name="Bento 02">
      <div className="flex flex-col items-center justify-end max-w-[inherit] min-w-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-end max-w-[inherit] min-w-[inherit] px-[20.267px] py-[30px] relative size-full">
          <BentoContent1 />
        </div>
...
function Row() {
  return (
    <div className="content-stretch flex gap-[20px] items-center justify-center relative shrink-0 w-full" data-name="Row 1">
      <Bento />
      <Bento1 />
    </div>
  );
...
function Bento2() {
  return (
    <div className="bg-[#d2fd9c] flex-[1_0_0] h-[222px] max-w-[500px] min-h-px min-w-[275px] relative rounded-[10.667px]" data-name="Bento 03">
      <div className="content-stretch flex flex-col items-start max-w-[inherit] min-w-[inherit] px-[51px] py-[26px] relative size-full">
        <BentoContent2 />
      </div>
    </div>
  );
...
function Bento3() {
  return (
    <div className="bg-[#d2fd9c] flex-[1_0_0] h-[221.867px] max-w-[500px] min-h-px min-w-[275px] relative rounded-[10.667px]" data-name="Bento 04">
      <div className="flex flex-col items-center justify-end max-w-[inherit] min-w-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-end max-w-[inherit] min-w-[inherit] px-[20.267px] py-[30px] relative size-full">
          <BentoContent3 />
        </div>
...
function Row1() {
  return (
    <div className="content-stretch flex gap-[20px] items-center justify-center relative shrink-0 w-full" data-name="Row 2">
      <Bento2 />
      <Bento3 />
    </div>
  );
...
function GetMoreDoneSection() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Get more done section">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-center justify-center px-[40px] py-[80px] relative w-full">
          <Header1 />
          <BentoContainer />
        </div>
      </div>
...
function TheMostReliableApp() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[481px]" data-name="The Most Reliable App">
      <h2 className="block capitalize font-['Manrope:Regular',sans-serif] font-normal leading-[1.058] relative shrink-0 text-[#394508] text-[42px] text-center tracking-[-0.84px] whitespace-nowrap">The Most Reliable App</h2>
    </div>
  );
}
...
function BenefitImage() {
  return (
    <div className="aspect-[285/221.86666870117188] relative rounded-[10px] shrink-0 w-full" data-name="Benefit image">
...
function BenefitInformation() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Medium',sans-serif] font-medium items-start leading-[1.15] relative shrink-0 text-[12px] w-full" data-name="Benefit information">
      <p className="relative shrink-0 text-[#394508] w-full">Scale Your Team, Not Your Card Expenses</p>
      <div className="relative shrink-0 text-[#5d5d5d] w-full">
        <p className="mb-0">Issue virtual and physical cards at no additional cost to support teams of any size.</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function BenefitContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[19px] items-start min-h-px min-w-px relative" data-name="Benefit container">
      <BenefitImage />
      <BenefitInformation />
    </div>
  );
...
function BenefitInformation1() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Medium',sans-serif] font-medium items-start leading-[1.15] relative shrink-0 text-[12px] w-full" data-name="Benefit information">
      <p className="relative shrink-0 text-[#394508] w-full">Effortless Paper Tracking, Mobile Convenience</p>
...
function SectionContent() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full" data-name="Section content">
      <BenefitContainer />
      <BenefitContainer1 />
    </div>
  );
...
function ReliableAppSection() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Reliable app section">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-center px-[40px] py-[80px] relative w-full">
          <TheMostReliableApp />
          <SectionContent />
        </div>
      </div>
...
function Image() {
  return (
    <div className="h-[350px] relative rounded-[10px] shrink-0 w-full" data-name="Image">
...
function ImageBreaker() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Image breaker">
      <div className="content-stretch flex flex-col items-start px-[40px] py-[100px] relative w-full">
        <Image />
      </div>
    </div>
  );
...
function SectionHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0" data-name="Section header">
      <Headline />
...
function IconContainer() {
  return (
    <div className="aspect-[140.75/115.75] relative rounded-[10px] shrink-0 w-full" data-name="Icon container">
...
function IconInformationContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[15px] items-center min-h-px min-w-px relative" data-name="Icon information container">
      <IconContainer />
...
function IconSectionContainer() {
  return (
    <div className="content-stretch flex gap-[40px] items-center pb-[8px] relative shrink-0 w-full" data-name="Icon section container">
...
function CtaCopy() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-[310px]" data-name="CTA copy">
      <h3 className="block font-['Manrope:Regular',sans-serif] font-normal leading-[1.09] min-w-full relative shrink-0 text-[32px] text-white tracking-[-0.64px] w-[min-content]">Download Etran and manage everything from your phone.</h3>
      <a className="bg-[#d2fd9c] content-stretch cursor-pointer flex items-center justify-center px-[14px] py-[11px] relative rounded-[2.064px] shrink-0" data-name="Button" href="https://figma.com/sites">
        <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[1.058] relative shrink-0 text-[10px] text-black text-left tracking-[-0.2px] whitespace-nowrap">Get started</p>
      </a>
    </div>
  ...
  return (
    <div className="h-[350px] relative rounded-[10px] shrink-0 w-full" data-name="CTA content">
      ...
      <div className="flex flex-col justify-end overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-end pb-[34px] pt-[65px] px-[40px] relative size-full">
          <CtaCopy />
        </div>
      </div>
    </div>
...
function CtaSection() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="CTA section">
      <div className="content-stretch flex flex-col items-start pb-[100px] pt-[50px] px-[40px] relative w-full">
        <CtaContent />
      </div>
    </div>
  );
...
function LeftSideFooterContainer() {
  return (
    <div aria-label="Etran name and logo" className="content-stretch flex flex-col gap-[141px] h-full items-start relative shrink-0 w-[124px]" data-name="Left side footer container">
      <Logo1 />
...
function RightSideFooterContainer() {
  return (
    <div className="content-stretch flex flex-col font-['Manrope:Medium',sans-serif] font-medium h-full items-start justify-between leading-[1.15] relative shrink-0 text-[12px]" data-name="Right side footer container">
      <ContactDetails />
      <TermsAndConditions />
    </div>
  );
...
function Footer() {
  return (
    <footer className="bg-[#ededed] h-[300px] relative shrink-0 w-full" data-name="Footer">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start justify-between px-[40px] py-[31px] relative size-full">
...
export default function Desktop() {
  return (
    <div className="bg-[#394508] content-stretch flex flex-col items-center pl-[520px] relative size-full" data-name="Desktop">
      <SidebarContainer />
      <Main />
      <Footer />
    </div>
